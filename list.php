            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        var nameStudent = '<tr id="'+res.data.id+'">';
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.status && typeof res.data === 'object') {
                        ...
                        var student = '<span>'+ res.data.first_name +' '+ res.data.last_name +'</span>';
                        var row = '<tr>';
                        row += '<td>' + res.data.id + '</td>';
                        row += '<td>' + res.data.first_name + '</td>';
                        row += '<td>' + res.data.last_name + '</td>';
                        row += '<td>' + res.data.address + '</td>';
                        row += '</tr>';
    ...
    $("#updateStudent").validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                ...
                dataType: 'json',
                success: function (res) {
                    var student  = '<h3>'+ res.data.first_name+'</h3>';
